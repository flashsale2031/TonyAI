...
if (start < 0) throw new Error('Canonical question array was not found');
const end = source.indexOf('];', start);
if (end < 0) throw new Error('Canonical question array terminator was not found');
const literal = source.slice(source.indexOf('[', start), end + 1);
const questions = Function(`return (${literal})`)();
