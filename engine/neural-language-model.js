...
const tokenize=s=>String(s||'').toLowerCase().match(TOKEN)||[];
...
export const createNeuralLanguageModel=({corpus=NEURAL_TRAINING_TEXT,...options}={})=>new NeuralLanguageModel(options).train(corpus,options);
if(typeof window!=='undefined')window.TONYNeuralLanguageModel={NeuralLanguageModel,createNeuralLanguageModel};
