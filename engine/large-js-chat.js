...
export async function largeJSChat({messages=[],attachments=[]}={},assistant=null){
 ...
 if(!wantsImage){
  // Deterministic operations are resolved before live search. This keeps the
  // local-first path fast and prevents arithmetic/data requests from spawning
  // unnecessary Playwright browsers in CI and production.
