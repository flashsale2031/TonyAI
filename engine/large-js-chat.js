...
export async function largeJSChat({messages=[],attachments=[]}={},assistant=null){
 ...
 const needsEvidence=wants(latest,/\b(search|look up|latest|today|current|news|research|online|internet|sources?|what is|who is|where is|when is|how much|how many|compare|comparison|price|cost)\b/i);
