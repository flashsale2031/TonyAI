...
export class LargeParameterBrain7B extends BaseBrain{
 ...
 stats(){const s=super.stats();return{...s,architecture:'pure-javascript-7.0b-parameter-numerical-brain',parameterCount:5400000000+EXTRA_COUNT,baseParameters:5400000000,additionalParameters:EXTRA_COUNT,parameterType:'Float32Array',parameterBytes:(5400000000+EXTRA_COUNT)*4,biasParameters:s.biasParameters,totalNumericalParameters:5400000000+EXTRA_COUNT+s.biasParameters,extra7LearnedLocally:Boolean(this.extra7Updates),extra7Updates:this.extra7Updates||0,pretrained:false,externalNeuralModel:false};}
 serialize(){return JSON.stringify({version:1,base:JSON.parse(super.serialize()),extraCount:EXTRA_COUNT,extraSeed:this.extraSeed,extra7:Array.from(this.extra7),extra7Updates:this.extra7Updates||0});}
