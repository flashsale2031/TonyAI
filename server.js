...
async function handler(req,res){
  try{
    ...
    if(req.method==='GET'&&req.url==='/api/capabilities')return json(res,200,{...assistant.capabilities(),webRuntime:true,runtimeVersion:'2.0.0'});
    ...
    if(req.method==='GET'&&req.url==='/health')return json(res,200,{ok:true,service:'TONY',version:'2.0.0',capabilities:{...assistant.capabilities(),webRuntime:true,runtimeVersion:'2.0.0'}});
